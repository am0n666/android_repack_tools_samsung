...
mkbootimg$(EXE):
	...
	@$(CROSS_COMPILE)$(CC) external/samsung_tools/mkbootimg.c -o $@ $(CFLAGS) $(LIBS) libmincrypt_host.a
	@$(ECHO) "*******************************************"
...
unpackbootimg$(EXE):
	...
	@$(CROSS_COMPILE)$(CC) external/samsung_tools/unpackbootimg.c -o $@ $(CFLAGS) $(LIBS) libmincrypt_host.a
	@$(RM) -rfv *.a
	@$(ECHO) "*******************************************"

dtbtool$(EXE):
	@$(ECHO) "Building dtbtool..."
	@$(CROSS_COMPILE)$(CC) external/samsung_tools/dtbtool.c -o $@
	@$(ECHO) "*******************************************"
